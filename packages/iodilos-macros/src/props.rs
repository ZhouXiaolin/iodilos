...
//!
//! Ported from `sycamore-macro`'s `props` module. The HTML/SVG
//! `#[prop(attributes(html, <tag>))]` machinery is stripped: iodilos components
//! do not carry an `attributes` field (layout/paint props flow through the
//! element's own style-props system, not a collected `Attributes` bag).
//!
...
mod struct_info {
    ...
    pub struct StructInfo<'a> {
        ...
        pub fields: Vec<field_info::FieldInfo<'a>>,
    ...
    impl<'a> StructInfo<'a> {
        pub fn included_fields(&self) -> impl Iterator<Item = &field_info::FieldInfo<'a>> {
            self.fields
                .iter()
        ...
        pub fn new(
            ...
            let fields = fields
                .enumerate()
                .map(|(i, f)| {
                    field_info::FieldInfo::new(i, f, builder_attr.field_defaults.clone())
                })
                .collect::<Result<Vec<field_info::FieldInfo>, _>>()?;
        ...
        pub fn builder_creation_impl(&self) -> Result<TokenStream, Error> {
            ...
            Ok(quote! {
                impl #impl_generics ::iodilos::rt::Props for #name #ty_generics #where_clause {
        ...
        pub fn field_impl(&self, field: &field_info::FieldInfo) -> Result<TokenStream, Error> {
            ...
            Ok(quote! {
                ...
                #[doc(hidden)]
                #[allow(dead_code, non_camel_case_types, non_snake_case, missing_docs)]
    ...
    pub struct TypeBuilderAttr {
        ...
        pub field_defaults: field_info::FieldBuilderAttr,
    }
